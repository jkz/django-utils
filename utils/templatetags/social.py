...
def twitter_share(context, url=None, text='', via=None):
    ...
    if via:
        query['via'] = via
    return www.URL('https://twitter.com/intent/tweet', query=query, verbatim=True)
...
def facebook_share(context, url=None, title=None, summary=None, images=None):
    ...
    return www.URL('http://www.facebook.com/sharer/sharer.php', query=query, verbatim=True)
...
def googleplus_share(context, url=None):
    ...
    if url:
        ...
        query['url'] = context['request'].build_absolute_url()
    return www.URL('https://plus.google.com/share', query=query)
...
def pinterest_share(context, media, url=None, description=None):
    ...
    return www.URL('http://pinterest.com/pin/create/button/', query=query)
...
def tumblr_photo(context, source, url=None, caption=None):
    ...
    return www.URL('http://www.tumblr.com/share/photo', query=query)
